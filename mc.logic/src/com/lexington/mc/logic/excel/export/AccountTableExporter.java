...
public class AccountTableExporter {

	private static Logger        log          = Logger.getLogger(AccountTableExporter.class.getName());
	...
	public byte[] exportAccounts(Connection conn, BigDecimal bankId) throws MessageException {
		try {
			excelName = "Bank Accounts";
			fetchData(conn, bankId);
	...
	public void fetchData(Connection conn, BigDecimal bankId) throws MessageException {
		VExcelAccountTab tab = null;
		ResultSet rs = null;
		Statement statement = null;
		try {
			statement = conn.createStatement();
			
			tab = excelVAccount.getExcelDataForAccountsByBankId(conn, bankId);
	...
	public static void main(String[] args) throws FileNotFoundException {
		AccountTableExporter te = new AccountTableExporter();
