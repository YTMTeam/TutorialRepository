 ...
 *  <pre>
 *
 *  Generated Class: VExcelPositionSample.java
 * 
...
public class VExcelPositionSample {

   final static Logger log = Logger.getLogger(VExcelPositionSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VExcelPositionSample vExcelPositionSample = new VExcelPositionSample();
         ...
         *
         **********************************************************************/
         //vExcelPositionSample.select(connection);
         //vExcelPositionSample.insert(connection);
         //vExcelPositionSample.update(connection);

         //vExcelPositionSample.dataProvider1(connection);
         //vExcelPositionSample.dataProvider2(connection);

         //vExcelPositionSample.deleteViaResultSet(connection);
         //vExcelPositionSample.deleteViaSQL(connection);
         
         //vExcelPositionSample.batchInsert(connection);
         
         //vExcelPositionSample.selectIntoTransferObject(connection);
         
         //vExcelPositionSample.copyDataBetweenDatabases(connection_source, connection_target);
         //vExcelPositionSample.updateByToArray(connection_source, connection_target);
         
         //vExcelPositionSample.deleteByToArrayBatch(connection_source, connection_target);
         //vExcelPositionSample.deleteByToArray(connection_source, connection_target);
         
         //vExcelPositionSample.updateByTo(connection);
         //vExcelPositionSample.deleteByTo(connection);
   ...
   public void select(Connection connection) throws GDAOException {
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelPositionTab.getResultSet("WHERE UPPER(ACCOUNT_ID) LIKE ? AND ROWNUM < ?", "%R%", 100);
          ...
          *
          **********************************************************************/
         //vExcelPositionTab.getResultSet(null, (Object[])null);
         ...
         while (vExcelPositionTab.next()) {
            ...
            *
            **********************************************************************/
                  accountId = vExcelPositionTab.getACCOUNT_ID();
      bankId = vExcelPositionTab.getBANK_ID();
      accountNumber = vExcelPositionTab.getACCOUNT_NUMBER();
      firstName = vExcelPositionTab.getFIRST_NAME();
      lastName = vExcelPositionTab.getLAST_NAME();
      bankName = vExcelPositionTab.getBANK_NAME();
      securitySymbol = vExcelPositionTab.getSECURITY_SYMBOL();
      quantity = vExcelPositionTab.getQUANTITY();
      ...
      log.debug("Finished select from VIEW \"V_EXCEL_POSITION\".");
   }
   ...
   **********************************************************************/
   public void selectIntoTransferObject(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"selectIntoTransferObject()\" for VIEW \"V_EXCEL_POSITION\"";
       ...
       *
       **********************************************************************/
      VExcelPositionTab vExcelPositionTabForSelect = new VExcelPositionTab(connection);
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelPositionTabForSelect.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelPositionTabForSelect.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vExcelPositionTabForSelect.getResultSet("WHERE UPPER(CREDIT_DEBIT_CODE) LIKE ? AND ROWNUM < ?", "%C%", 100);
          ...
          *
          **********************************************************************/
         while (vExcelPositionTabForSelect.next()) {
            ...
            *
            **********************************************************************/
            VExcelPositionTo vExcelPositionTo  = vExcelPositionTabForSelect.getTo();
             ...
             **********************************************************************/
             /*
            vExcelPositionTo.setRECURRING_TRANS_HIST_ID(vExcelPositionTabForSelect.getNextval());
            vExcelPositionTo.setCOMMENTS("This is Zoran's test record");
            vExcelPositionTo.setREJECT_REASON(null);
            vExcelPositionTo.setCREATE_DATETIME(TimestampUtility.getCurrentTimestamp());
            */
             ...
             *
             **********************************************************************/
            VExcelPositionTab vExcelPositionTabForInsert = new VExcelPositionTab(connection);

            vExcelPositionTabForInsert.setThisFromTo(vExcelPositionTo);

            vExcelPositionTabForInsert.insertThisRecord();
         ...
         e.printStackTrace();
         log.error("Cannot select into TO's from VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      } finally {
         vExcelPositionTabForSelect.releaseStatement();
      }
   ...
   public void insert(Connection connection) throws GDAOException {
      ...
      log.debug("Starting insert into VIEW \"V_EXCEL_POSITION\"...");
      ...
      try {
         ...
         * BigDecimal VExcelPositionTab_id = VExcelPositionTab.getNextval(sequenceName);
         * or if sequence has a standard name like "S_V_EXCEL_POSITION":
         * BigDecimal VExcelPositionTab_id = VExcelPositionTab.getNextval();
         *
         **********************************************************************/
      ...
      quantity = new BigDecimal(0);
               ...
               vExcelPositionTab.setACCOUNT_ID(accountId);  // java.lang.String - Mandatory
      vExcelPositionTab.setBANK_ID(bankId);  // java.math.BigDecimal - Mandatory
      vExcelPositionTab.setACCOUNT_NUMBER(accountNumber);  // java.math.BigDecimal - Mandatory
      vExcelPositionTab.setFIRST_NAME(firstName);  // java.lang.String - Mandatory
      vExcelPositionTab.setLAST_NAME(lastName);  // java.lang.String - Mandatory
      vExcelPositionTab.setBANK_NAME(bankName);  // java.lang.String - Mandatory
      vExcelPositionTab.setSECURITY_SYMBOL(securitySymbol);  // java.lang.String - Mandatory
      vExcelPositionTab.setQUANTITY(quantity);  // java.math.BigDecimal - Mandatory
         ...
         e.printStackTrace();
         log.error("Cannot insert into VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      }
      

      log.debug("Finished insert into VIEW \"V_EXCEL_POSITION\".");
   }
   ...
   public void update(Connection connection) throws GDAOException {
      ...
      log.debug("Starting update of VIEW \"V_EXCEL_POSITION\".");
      ...
      try {
          ...
          *
          * Note:
          * Use vExcelPositionTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          *
          * OR
          *
          ...
          *
          **************************************************************************/
         //vExcelPositionTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          ...
          *
          **********************************************************************/
         vExcelPositionTab.getResultSetForUpdate("WHERE ACCOUNT_ID LIKE ?", "%R%");
          ...
          *
          **********************************************************************/
         //vExcelPositionTab.getResultSetForUpdate(null, (Object[])null);
          ...
          *
          **********************************************************************/
         log.info("ResultSet Row Count (number of records to be affected) = " + vExcelPositionTab.getResultSetRowCount());
      ...
      vExcelPositionTab.setQUANTITY(quantity);  // java.math.BigDecimal - Mandatory
           ...
           *
           ***********************************************************************/
            vExcelPositionTab.updateThisRecordInResultSet();
         ...
         e.printStackTrace();
         log.error("Cannot update VIEW \"V_EXCEL_POSITION\".");

         try {
            connection.rollback();  // rollback all updates
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for updating records from VIEW \"V_EXCEL_POSITION\".");
            e1.printStackTrace();
      ...
      log.debug("Finished update of VIEW \"V_EXCEL_POSITION\".");
   }
   ...
   public void deleteViaSQL(Connection connection) throws GDAOException {
      ...
      log.debug("Starting delete of VIEW \"V_EXCEL_POSITION\".");
      ...
      try {
         ...
         recordsDeleted = vExcelPositionTab.deleteRecords(SQL, "%R%");
          ...
          *
          **********************************************************************/
         log.info(recordsDeleted + " records are deleted from VIEW \"V_EXCEL_POSITION\"");
         ...
         e.printStackTrace();
         log.error("Cannot delete  records from VIEW \"V_EXCEL_POSITION\".");

         try {
            connection.rollback();  // rollback all deletes
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for deleting records from VIEW \"V_EXCEL_POSITION\".");
            e1.printStackTrace();
            throw new GDAOException(e1);
         }
         throw new GDAOException(e);
      ...
      log.debug("Finished delete of VIEW \"V_EXCEL_POSITION\".");
   }
   ...
   **********************************************************************/
   public void updateByTo(Connection connection) throws GDAOException {
      ...
      log.debug("Starting UPDATE by TO of VIEW \"V_EXCEL_POSITION\".");
      ...
      try {
         ...
         *
         **********************************************************************/
         //vExcelPositionTab.getResultSet("WHERE UPPER(USERNAME) LIKE ? ", "%Z%");
         //vExcelPositionTab.getResultSet(null, (Object[])null);
         //vExcelPositionTab.getAllRecordsRs();
         ...
         while (vExcelPositionTab.next()) {
            ...
            *
            **********************************************************************/
            VExcelPositionTo vExcelPositionTo = vExcelPositionTab.getTo();
            ...
            *
            **********************************************************************/
            //vExcelPositionTo.setCITY("Belgrado"); 
            
            int recordsAffected = vExcelPositionTab.updateRecordUsingTo(vExcelPositionTo);
            ...
            **********************************************************************/
            ...
            //Alternative method:
            //recordsDeleted = vExcelPositionTab.updateRecordsUsingPKs(SQL, vExcelPositionTo.getV_EXCEL_POSITION_ID());
         ...
         e.printStackTrace();
         log.error("Cannot update records from VIEW \"V_EXCEL_POSITION\".");
   ...
   **********************************************************************/
         ...
         **********************************************************************/
         ...
         while (vExcelPositionTab.next()) {
            ...
            **********************************************************************/
            ...
            int recordsAffected = vExcelPositionTab.deleteRecordUsingTo(vExcelPositionTo);
         
            log.info("Deleted " + recordsAffected + " record with PK values: "  );

            //Alternative method:
            //recordsDeleted = vExcelPositionTab.deleteRecordsUsingPKs(SQL, vExcelPositionTo.getV_EXCEL_POSITION_ID());
   ...
   public void deleteViaSQLS(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaSQLS()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         while (recordsDeleted !=0) {
            recordsDeleted = vExcelPositionTab.deleteRecords(SQL, "%R%", deleteThisManyRecords);
   ...
   public void deleteViaResultSet(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaResultSet()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelPositionTab.getResultSet("WHERE ACCOUNT_ID LIKE ?", "%R%");
         ...
         while (vExcelPositionTab.next()) {
            ...
            vExcelPositionTab.deleteThisRecordFromResultSet();
            recordsProcessed++;
   ...
   **********************************************************************/
   public void batchInsert(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"batchInsert()\" for VIEW \"V_EXCEL_POSITION\"";

      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      int[] insertCounts = null;
      PreparedStatement ps = null;
      VExcelPositionTab vExcelPositionTab = null;
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER TABLE V_EXCEL_POSITION DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE TABLE V_EXCEL_POSITION";
         oracleSystemTab.runSQL(SQL);

         log.info("VIEW \"V_EXCEL_POSITION\" is truncated.");

         vExcelPositionTab = new VExcelPositionTab(connection);
         ...
         * V_EXCEL_POSITION_BKP 
         * This will affect only selects from this DAO object.
         *
         **********************************************************************/
         vExcelPositionTab.setDbEntityName("V_EXCEL_POSITION_BKP");
         vExcelPositionTab.getAllRecordsRs();

         vExcelPositionTab.setDbEntityName("V_EXCEL_POSITION");
         ps = vExcelPositionTab.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vExcelPositionTab.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_EXCEL_POSITION_BKP
             * using DAO object "vExcelPositionTo"
             *
             **********************************************************************/
            VExcelPositionTo vExcelPositionTo = vExcelPositionTab.getTo();
            vExcelPositionTab.addInsertBatch(ps, vExcelPositionTo);
            ...
            if (recordsInserted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Inserted and committed " + recordsInserted + " records into VIEW \"V_EXCEL_POSITION\".");
            }
         }
         ...
         e.printStackTrace();
         log.error("Cannot perform DDL/DML on VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      } catch (SQLException e) {
         e.printStackTrace();
         throw new GDAOException(e);
   ...
   **********************************************************************/
   public void batchDelete(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"batchDelete()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         //log.info("VIEW \"V_EXCEL_POSITION\" indexes are dropped.");
         ...
         **********************************************************************/
         ...
         vExcelPositionTab.setDbEntityName("V_EXCEL_POSITION");
         ps = vExcelPositionTab.getDeleteByPkPreparedStatement();
         ...
         while (vExcelPositionTab.next()) {
            ...
            if (recordsDeleted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Deleted and committed " + recordsDeleted + " records from VIEW \"V_EXCEL_POSITION\".");
            }
         }
   ...
   **********************************************************************/
   public void dataProvider1(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider1()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         vExcelPositionTab.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelPositionTab.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         //vExcelPositionTab.getResultSet("WHERE UPPER(ACCOUNT_ID) LIKE ?", "%R%");
         ...
         **********************************************************************/
         while (vExcelPositionTab.next()) {
            ...
            VExcelPositionTo vExcelPositionTo = vExcelPositionTab.getTo();
             ...
             /**********************************************************************
             *
             * Now use "vExcelPositionTo" object.
            ...
            VExcelPositionTab.print(vExcelPositionTo, "; ");
            ...
            * Change some values:
            * For example:
            * vExcelPositionTo.setSOME_VALUE(123);
            * vExcelPositionTo.setSOME_OTHER_VALUE("Some name");
            * etc...
            *
            **********************************************************************/
            ...
            /**********************************************************************
            *
            * Update row in VIEW \"V_EXCEL_POSITION\" with values from this
            * Transfer Object vExcelPositionTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            * vExcelPositionTo will be used to find
            * record to be updated. Generally those values should not be changed.
            *
            **********************************************************************/
            //vExcelPositionTab.update(vExcelPositionTo);

            /**********************************************************************
            *
            * Insert row in VIEW \"V_EXCEL_POSITION\" using values set in
            * this Transfer Object vExcelPositionTo.
            *
            * NOTE:
            * Remember that values for Primary Key have to be unique.
            * Transfer Object vExcelPositionTo could be also
            * created from scratch (not retrieved from the database).
            *
            **********************************************************************/
            //vExcelPositionTab.insert(vExcelPositionTo);

            /**********************************************************************
            *
            * Delete row in VIEW \"V_EXCEL_POSITION\" with values from this
            * Transfer Object vExcelPositionTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            ...
            *
            **********************************************************************/
            //vExcelPositionTab.delete(vExcelPositionTo);
         }
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Cannot fetch data from VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      } finally {
         vExcelPositionTab.releaseStatement();
      }
   ...
   **********************************************************************/
   public void dataProvider2(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider2()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
          ...
          * array "vExcelPositionToArray".
          * If there is less than "sampleTransferObjectArraySize"  rows returned
          * then all available data will be stored into array
          * "vExcelPositionToArray".
          *
          * Alternatively you can use parameter "BaseOracleDbEntityClass.FETCH_ALL"
          * to fetch all records returned by result set.
          *
          **********************************************************************/
         //ArrayList<VExcelPositionTo> vExcelPositionToArray = vExcelPositionTab.getToArray(sampleTransferObjectArraySize);
         ArrayList<VExcelPositionTo> vExcelPositionToArray = vExcelPositionTab.getToArray(BaseOracleDbEntityClass.FETCH_ALL);

         Iterator<VExcelPositionTo> iterator = vExcelPositionToArray.iterator();
         while (iterator.hasNext()) {
            VExcelPositionTo vExcelPositionTo = iterator.next();
   ...
   **********************************************************************/
   public void copyDataBetweenDatabases(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"copyDataBetweenDatabases()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      VExcelPositionTab vExcelPositionTabSource = null;
      VExcelPositionTab vExcelPositionTabTarget = null;
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER VIEW V_EXCEL_POSITION DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE VIEW V_EXCEL_POSITION";
         oracleSystemTabTarget.runSQL(SQL);

         log.info("Target VIEW \"V_EXCEL_POSITION\" is truncated.");

         vExcelPositionTabSource = new VExcelPositionTab(sourceConnection);
         vExcelPositionTabTarget = new VExcelPositionTab(targetConnection);
         ...
         *
         **********************************************************************/
         vExcelPositionTabSource.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelPositionTabSource.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vExcelPositionTabTarget.setResultSetConcurrency(ResultSet.CONCUR_UPDATABLE);
         vExcelPositionTabTarget.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         vExcelPositionTabSource.getAllRecordsRs();
          ...
          *
          **********************************************************************/
         preparedStatement = vExcelPositionTabTarget.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vExcelPositionTabSource.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_EXCEL_POSITION
             * using DAO object "vExcelPositionTabSource"
             *
             ...
             *
             **********************************************************************/
            VExcelPositionTo vExcelPositionTo = vExcelPositionTabSource.getTo();

            vExcelPositionTabTarget.addInsertBatch(preparedStatement, vExcelPositionTo);
         ...
         try {
            vExcelPositionTabSource.releaseStatement();
   ...
   **********************************************************************/
   public void deleteByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArrayBatch()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Delete: " + vExcelPositionTabTarget.getRowCount());
          ...
          **********************************************************************/
         vExcelPositionTabSource.getAllRecordsRs();
         ArrayList<VExcelPositionTo> vExcelPositionToArrayList = vExcelPositionTabSource.getToArrayEntireResultSet();
          ...
          *
          **********************************************************************/
         preparedStatement = vExcelPositionTabTarget.getDeleteByPkPreparedStatement();

         Iterator<VExcelPositionTo> iterator = vExcelPositionToArrayList.iterator();
         ...
         while (iterator.hasNext()) {
            ...
            VExcelPositionTo vExcelPositionTo = iterator.next();
            vExcelPositionTabTarget.deleteByToAddToBach(preparedStatement, vExcelPositionTo);
            ...
            if (executedDeleteStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Deleted " + executedDeleteStatement + " records from VIEW \"V_EXCEL_POSITION\".");
               } else {
                  /**********************************************************************
                   *
                   ...
                   *
                   **********************************************************************/
                  log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_EXCEL_POSITION\".");
               }
            }
         }
         ...
         log.info("Number of records after Batch Delete: " + vExcelPositionTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long deleteByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArray()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Delete: " + vExcelPositionTabTarget.getRowCount());
          ...
          **********************************************************************/
         vExcelPositionTabSource.getAllRecordsRs();
         //vExcelPositionTabSource.getResultSet("WHERE OPERATION_TYPE = ?", "M");
          ...
          * using DAO Object "vExcelPositionTabTarget"
          *
          **********************************************************************/
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            int recordsDeleted = vExcelPositionTabTarget.deleteRecordUsingTo(vExcelPositionTo);
            
            //alternative method - to be tested:
            //vExcelPositionTabTarget.delete(vExcelPositionTo);
            ...
            if (totalRecordsDeleted % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Deleted " + totalRecordsDeleted + " records from VIEW \"V_EXCEL_POSITION\".");
               log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_EXCEL_POSITION\".");
            }
         }
         ...
         log.info("Number of records after Delete: " + vExcelPositionTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArray()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Update: " + vExcelPositionTabTarget.getRowCount());
         ...
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            //vExcelPositionTo.setOPERATION_TYPE("Z");
             ...
             *
             **********************************************************************/
            int recordsUpdated = vExcelPositionTabTarget.updateRecordUsingTo(vExcelPositionTo);
            ...
            if (totalRecordsUpdated % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Updated " + totalRecordsUpdated + " records in VIEW \"V_EXCEL_POSITION\".");
               log.info("Executed " + executedUpdateStatement + " UPDATE statements for VIEW \"V_EXCEL_POSITION\".");
            }
         }
         ...
         log.info("Number of records after Update: " + vExcelPositionTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArrayBatch()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Update: " + vExcelPositionTabTarget.getRowCount());
          ...
          *
          **********************************************************************/
         preparedStatementForUpdate = vExcelPositionTabTarget.getUpdateByPkPreparedStatement();
         ...
         while (iterator.hasNext()) {
            ...
            vExcelPositionTabTarget.updateByToAddToBach(preparedStatementForUpdate, vExcelPositionTo);
            ...
            if (executedUpdateStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Updated " + executedUpdateStatement + " records in VIEW \"V_EXCEL_POSITION\".");
               } else {
                  /**********************************************************************
                   *
                   * Results from JDBC are unreliable so we only know that statements are
         ...
         log.info("Number of records after Batch Update: " + vExcelPositionTabTarget.getRowCount());
...
/*************************************************************************
     ...
     //vExcelPositionTabSource.setDbEntityName("GDAODEMO.V_EXCEL_POSITION");
