 ...
 *  <pre>
 *
 *  Generated Class: VTradeSample.java
 * 
 ...
 *
 *  This code is generated on: 2017-February-27 06:45:59 PM CET
 *   
 ...
 *
 *  Sample GDAO code for VIEW "V_TRADE"
 *
...
public class VTradeSample {

   final static Logger log = Logger.getLogger(VTradeSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VTradeSample vTradeSample = new VTradeSample();
         ...
         *
         **********************************************************************/
         //vTradeSample.select(connection);
         //vTradeSample.insert(connection);
         //vTradeSample.update(connection);

         //vTradeSample.dataProvider1(connection);
         //vTradeSample.dataProvider2(connection);

         //vTradeSample.deleteViaResultSet(connection);
         //vTradeSample.deleteViaSQL(connection);
         
         //vTradeSample.batchInsert(connection);
         
         //vTradeSample.selectIntoTransferObject(connection);
         
         //vTradeSample.copyDataBetweenDatabases(connection_source, connection_target);
         //vTradeSample.updateByToArray(connection_source, connection_target);
         
         //vTradeSample.deleteByToArrayBatch(connection_source, connection_target);
         //vTradeSample.deleteByToArray(connection_source, connection_target);
         
         //vTradeSample.updateByTo(connection);
         //vTradeSample.deleteByTo(connection);
   ...
   public void select(Connection connection) throws GDAOException {
      ...
      VTradeTab vTradeTab = new VTradeTab(connection);
      ...
      try {
          ...
          *
          **********************************************************************/
         vTradeTab.getResultSet("WHERE UPPER(BANK_CODE) LIKE ? AND ROWNUM < ?", "%R%", 100);
         ...
         while (vTradeTab.next()) {
            ...
            *
            **********************************************************************/
                  tradeId = vTradeTab.getTRADE_ID();
      bankId = vTradeTab.getBANK_ID();
      bankCode = vTradeTab.getBANK_CODE();
      bankName = vTradeTab.getBANK_NAME();
      accountId = vTradeTab.getACCOUNT_ID();
      firstName = vTradeTab.getFIRST_NAME();
      lastName = vTradeTab.getLAST_NAME();
      securitySymbol = vTradeTab.getSECURITY_SYMBOL();
      netAmount = vTradeTab.getNET_AMOUNT();
      currency = vTradeTab.getCURRENCY();
      quantity = vTradeTab.getQUANTITY();
      transactionType = vTradeTab.getTRANSACTION_TYPE();
      exchange = vTradeTab.getEXCHANGE();
      tradeDate = vTradeTab.getTRADE_DATE();
      createTimestamp = vTradeTab.getCREATE_TIMESTAMP();
      ...
      log.debug(String.format("%-30s [%s]", "createTimestamp", createTimestamp));
         ...
         e.printStackTrace();
         log.error("Cannot select from VIEW \"V_TRADE\".");
         throw new GDAOException(e);
      } finally {
         vTradeTab.releaseStatement();
      }

      log.debug("Finished select from VIEW \"V_TRADE\".");
   }
   ...
   **********************************************************************/
   public void selectIntoTransferObject(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"selectIntoTransferObject()\" for VIEW \"V_TRADE\"";
       ...
       *
       **********************************************************************/
      VTradeTab vTradeTabForSelect = new VTradeTab(connection);
      ...
      try {
          ...
          *
          **********************************************************************/
         vTradeTabForSelect.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vTradeTabForSelect.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vTradeTabForSelect.getResultSet("WHERE UPPER(CREDIT_DEBIT_CODE) LIKE ? AND ROWNUM < ?", "%C%", 100);
         ...
         while (vTradeTabForSelect.next()) {
            ...
            *
            **********************************************************************/
            VTradeTo vTradeTo  = vTradeTabForSelect.getTo();
             ...
             **********************************************************************/
             /*
            vTradeTo.setRECURRING_TRANS_HIST_ID(vTradeTabForSelect.getNextval());
            vTradeTo.setCOMMENTS("This is Zoran's test record");
            vTradeTo.setREJECT_REASON(null);
            vTradeTo.setCREATE_DATETIME(TimestampUtility.getCurrentTimestamp());
            */
             ...
             *
             **********************************************************************/
            VTradeTab vTradeTabForInsert = new VTradeTab(connection);

            vTradeTabForInsert.setThisFromTo(vTradeTo);

            vTradeTabForInsert.insertThisRecord();
         ...
         e.printStackTrace();
         log.error("Cannot select into TO's from VIEW \"V_TRADE\".");
         throw new GDAOException(e);
      } finally {
         vTradeTabForSelect.releaseStatement();
      }
   ...
   public void insert(Connection connection) throws GDAOException {
      ...
      log.debug("Starting insert into VIEW \"V_TRADE\"...");
      ...
      try {
         ...
         * BigDecimal VTradeTab_id = VTradeTab.getNextval(sequenceName);
         * or if sequence has a standard name like "S_V_TRADE":
         * BigDecimal VTradeTab_id = VTradeTab.getNextval();
         *
         **********************************************************************/
      ...
      createTimestamp = TimestampUtility.getCurrentTimestamp();
               ...
               vTradeTab.setTRADE_ID(tradeId);  // java.math.BigDecimal - Mandatory
      vTradeTab.setBANK_ID(bankId);  // java.math.BigDecimal - Mandatory
      vTradeTab.setBANK_CODE(bankCode);  // java.lang.String
      vTradeTab.setBANK_NAME(bankName);  // java.lang.String
      vTradeTab.setACCOUNT_ID(accountId);  // java.lang.String - Mandatory
      vTradeTab.setFIRST_NAME(firstName);  // java.lang.String
      vTradeTab.setLAST_NAME(lastName);  // java.lang.String
      vTradeTab.setSECURITY_SYMBOL(securitySymbol);  // java.lang.String - Mandatory
      vTradeTab.setNET_AMOUNT(netAmount);  // java.math.BigDecimal - Mandatory
      vTradeTab.setCURRENCY(currency);  // java.lang.String - Mandatory
      vTradeTab.setQUANTITY(quantity);  // java.math.BigDecimal - Mandatory
      vTradeTab.setTRANSACTION_TYPE(transactionType);  // java.lang.String - Mandatory
      vTradeTab.setEXCHANGE(exchange);  // java.lang.String - Mandatory
      vTradeTab.setTRADE_DATE(tradeDate);  // java.sql.Timestamp
      vTradeTab.setCREATE_TIMESTAMP(createTimestamp);  // java.sql.Timestamp - Mandatory


         vTradeTab.insertThisRecord();

      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Cannot insert into VIEW \"V_TRADE\".");
         throw new GDAOException(e);
      }
      

      log.debug("Finished insert into VIEW \"V_TRADE\".");
   }
   ...
   public void update(Connection connection) throws GDAOException {
      ...
      log.debug("Starting update of VIEW \"V_TRADE\".");
      ...
      try {
          ...
          *
          * Note:
          * Use vTradeTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          *
          * OR
          *
          ...
          *
          **************************************************************************/
         //vTradeTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          ...
          *
          **********************************************************************/
         vTradeTab.getResultSetForUpdate("WHERE BANK_CODE LIKE ?", "%R%");
          ...
          *
          **********************************************************************/
         //vTradeTab.getResultSetForUpdate(null, (Object[])null);
          ...
          *
          **********************************************************************/
         log.info("ResultSet Row Count (number of records to be affected) = " + vTradeTab.getResultSetRowCount());
      ...
      vTradeTab.setCREATE_TIMESTAMP(createTimestamp);  // java.sql.Timestamp - Mandatory
           ...
           *
           ***********************************************************************/
            vTradeTab.updateThisRecordInResultSet();
         ...
         e.printStackTrace();
         log.error("Cannot update VIEW \"V_TRADE\".");

         try {
            connection.rollback();  // rollback all updates
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for updating records from VIEW \"V_TRADE\".");
            e1.printStackTrace();
      ...
      log.debug("Finished update of VIEW \"V_TRADE\".");
   }
   ...
   public void deleteViaSQL(Connection connection) throws GDAOException {
      ...
      log.debug("Starting delete of VIEW \"V_TRADE\".");
      ...
      try {
         ...
         recordsDeleted = vTradeTab.deleteRecords(SQL, "%R%");
          ...
          *
          **********************************************************************/
         log.info(recordsDeleted + " records are deleted from VIEW \"V_TRADE\"");
         ...
         e.printStackTrace();
         log.error("Cannot delete  records from VIEW \"V_TRADE\".");

         try {
            connection.rollback();  // rollback all deletes
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for deleting records from VIEW \"V_TRADE\".");
            e1.printStackTrace();
            throw new GDAOException(e1);
         }
         throw new GDAOException(e);
      ...
      log.debug("Finished delete of VIEW \"V_TRADE\".");
   }
   ...
   **********************************************************************/
   public void updateByTo(Connection connection) throws GDAOException {
      ...
      log.debug("Starting UPDATE by TO of VIEW \"V_TRADE\".");
      ...
      try {
         ...
         *
         **********************************************************************/
         //vTradeTab.getResultSet("WHERE UPPER(USERNAME) LIKE ? ", "%Z%");
         //vTradeTab.getResultSet(null, (Object[])null);
         //vTradeTab.getAllRecordsRs();
         ...
         while (vTradeTab.next()) {
            ...
            *
            **********************************************************************/
            VTradeTo vTradeTo = vTradeTab.getTo();
            ...
            *
            **********************************************************************/
            //vTradeTo.setCITY("Belgrado"); 
            
            int recordsAffected = vTradeTab.updateRecordUsingTo(vTradeTo);
            ...
            **********************************************************************/
            ...
            //Alternative method:
            //recordsDeleted = vTradeTab.updateRecordsUsingPKs(SQL, vTradeTo.getV_TRADE_ID());
         ...
         e.printStackTrace();
         log.error("Cannot update records from VIEW \"V_TRADE\".");
   ...
   **********************************************************************/
         ...
         **********************************************************************/
         ...
         while (vTradeTab.next()) {
            ...
            **********************************************************************/
            ...
            int recordsAffected = vTradeTab.deleteRecordUsingTo(vTradeTo);
         
            log.info("Deleted " + recordsAffected + " record with PK values: "  );

            //Alternative method:
            //recordsDeleted = vTradeTab.deleteRecordsUsingPKs(SQL, vTradeTo.getV_TRADE_ID());
   ...
   public void deleteViaSQLS(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaSQLS()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         while (recordsDeleted !=0) {
            recordsDeleted = vTradeTab.deleteRecords(SQL, "%R%", deleteThisManyRecords);
   ...
   public void deleteViaResultSet(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaResultSet()\" for VIEW \"V_TRADE\"";
      ...
      try {
          ...
          *
          **********************************************************************/
         vTradeTab.getResultSet("WHERE BANK_CODE LIKE ?", "%R%");
         ...
         while (vTradeTab.next()) {
            ...
            vTradeTab.deleteThisRecordFromResultSet();
            recordsProcessed++;
   ...
   **********************************************************************/
   public void batchInsert(Connection connection) throws GDAOException {
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER TABLE V_TRADE DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE TABLE V_TRADE";
         oracleSystemTab.runSQL(SQL);

         log.info("VIEW \"V_TRADE\" is truncated.");

         vTradeTab = new VTradeTab(connection);
         ...
         *
         **********************************************************************/
         vTradeTab.setDbEntityName("V_TRADE_BKP");
         vTradeTab.getAllRecordsRs();

         vTradeTab.setDbEntityName("V_TRADE");
         ps = vTradeTab.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vTradeTab.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_TRADE_BKP
             * using DAO object "vTradeTo"
             *
             **********************************************************************/
            VTradeTo vTradeTo = vTradeTab.getTo();
            vTradeTab.addInsertBatch(ps, vTradeTo);
            ...
            if (recordsInserted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Inserted and committed " + recordsInserted + " records into VIEW \"V_TRADE\".");
            }
         }
         ...
         e.printStackTrace();
         log.error("Cannot perform DDL/DML on VIEW \"V_TRADE\".");
         throw new GDAOException(e);
      } catch (SQLException e) {
         e.printStackTrace();
         throw new GDAOException(e);
   ...
   **********************************************************************/
   public void batchDelete(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"batchDelete()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         //log.info("VIEW \"V_TRADE\" indexes are dropped.");
         ...
         **********************************************************************/
         ...
         vTradeTab.setDbEntityName("V_TRADE");
         ps = vTradeTab.getDeleteByPkPreparedStatement();
         ...
         while (vTradeTab.next()) {
            ...
            if (recordsDeleted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Deleted and committed " + recordsDeleted + " records from VIEW \"V_TRADE\".");
            }
         }
   ...
   **********************************************************************/
   public void dataProvider1(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider1()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         vTradeTab.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vTradeTab.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         //vTradeTab.getResultSet("WHERE UPPER(BANK_CODE) LIKE ?", "%R%");
         ...
         **********************************************************************/
         while (vTradeTab.next()) {
            ...
            * Change some values:
            * For example:
            * vTradeTo.setSOME_VALUE(123);
            * vTradeTo.setSOME_OTHER_VALUE("Some name");
            * etc...
            *
            **********************************************************************/
            ...
            /**********************************************************************
            *
            * Update row in VIEW \"V_TRADE\" with values from this
            * Transfer Object vTradeTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            * vTradeTo will be used to find
            * record to be updated. Generally those values should not be changed.
            *
            **********************************************************************/
            //vTradeTab.update(vTradeTo);

            /**********************************************************************
            *
            * Insert row in VIEW \"V_TRADE\" using values set in
            * this Transfer Object vTradeTo.
            *
            * NOTE:
            * Remember that values for Primary Key have to be unique.
            * Transfer Object vTradeTo could be also
            * created from scratch (not retrieved from the database).
            *
            **********************************************************************/
            //vTradeTab.insert(vTradeTo);

            /**********************************************************************
            *
            * Delete row in VIEW \"V_TRADE\" with values from this
            * Transfer Object vTradeTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            ...
            *
            **********************************************************************/
            //vTradeTab.delete(vTradeTo);
         }
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Cannot fetch data from VIEW \"V_TRADE\".");
         throw new GDAOException(e);
      } finally {
         vTradeTab.releaseStatement();
      }
   ...
   **********************************************************************/
   public void dataProvider2(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider2()\" for VIEW \"V_TRADE\"";
      ...
      try {
          ...
          *
          **********************************************************************/
         //ArrayList<VTradeTo> vTradeToArray = vTradeTab.getToArray(sampleTransferObjectArraySize);
         ArrayList<VTradeTo> vTradeToArray = vTradeTab.getToArray(BaseOracleDbEntityClass.FETCH_ALL);

         Iterator<VTradeTo> iterator = vTradeToArray.iterator();
         while (iterator.hasNext()) {
            VTradeTo vTradeTo = iterator.next();
   ...
   **********************************************************************/
   public void copyDataBetweenDatabases(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"copyDataBetweenDatabases()\" for VIEW \"V_TRADE\"";
      ...
      VTradeTab vTradeTabSource = null;
      VTradeTab vTradeTabTarget = null;
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER VIEW V_TRADE DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE VIEW V_TRADE";
         oracleSystemTabTarget.runSQL(SQL);

         log.info("Target VIEW \"V_TRADE\" is truncated.");

         vTradeTabSource = new VTradeTab(sourceConnection);
         vTradeTabTarget = new VTradeTab(targetConnection);
         ...
         *
         **********************************************************************/
         vTradeTabSource.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vTradeTabSource.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vTradeTabTarget.setResultSetConcurrency(ResultSet.CONCUR_UPDATABLE);
         vTradeTabTarget.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         vTradeTabSource.getAllRecordsRs();
          ...
          *
          **********************************************************************/
         preparedStatement = vTradeTabTarget.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vTradeTabSource.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_TRADE
             * using DAO object "vTradeTabSource"
             *
             ...
             *
             **********************************************************************/
            VTradeTo vTradeTo = vTradeTabSource.getTo();

            vTradeTabTarget.addInsertBatch(preparedStatement, vTradeTo);
         ...
         try {
            vTradeTabSource.releaseStatement();
   ...
   **********************************************************************/
   public void deleteByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArrayBatch()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Delete: " + vTradeTabTarget.getRowCount());
          ...
          **********************************************************************/
         vTradeTabSource.getAllRecordsRs();
         ArrayList<VTradeTo> vTradeToArrayList = vTradeTabSource.getToArrayEntireResultSet();
          ...
          *
          **********************************************************************/
         preparedStatement = vTradeTabTarget.getDeleteByPkPreparedStatement();

         Iterator<VTradeTo> iterator = vTradeToArrayList.iterator();
         ...
         while (iterator.hasNext()) {
            ...
            VTradeTo vTradeTo = iterator.next();
            vTradeTabTarget.deleteByToAddToBach(preparedStatement, vTradeTo);
            ...
            if (executedDeleteStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Deleted " + executedDeleteStatement + " records from VIEW \"V_TRADE\".");
               } else {
                  /**********************************************************************
                   *
                   ...
                   *
                   **********************************************************************/
                  log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_TRADE\".");
               }
            }
         }
         ...
         log.info("Number of records after Batch Delete: " + vTradeTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long deleteByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArray()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Delete: " + vTradeTabTarget.getRowCount());
          ...
          **********************************************************************/
         vTradeTabSource.getAllRecordsRs();
         //vTradeTabSource.getResultSet("WHERE OPERATION_TYPE = ?", "M");
          ...
          * using DAO Object "vTradeTabTarget"
          *
          **********************************************************************/
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            int recordsDeleted = vTradeTabTarget.deleteRecordUsingTo(vTradeTo);
            
            //alternative method - to be tested:
            //vTradeTabTarget.delete(vTradeTo);
            ...
            if (totalRecordsDeleted % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Deleted " + totalRecordsDeleted + " records from VIEW \"V_TRADE\".");
               log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_TRADE\".");
            }
         }
         ...
         log.info("Number of records after Delete: " + vTradeTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArray()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Update: " + vTradeTabTarget.getRowCount());
         ...
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            int recordsUpdated = vTradeTabTarget.updateRecordUsingTo(vTradeTo);
            ...
            if (totalRecordsUpdated % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Updated " + totalRecordsUpdated + " records in VIEW \"V_TRADE\".");
               log.info("Executed " + executedUpdateStatement + " UPDATE statements for VIEW \"V_TRADE\".");
            }
         }
         ...
         log.info("Number of records after Update: " + vTradeTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArrayBatch()\" for VIEW \"V_TRADE\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Update: " + vTradeTabTarget.getRowCount());
          ...
          *
          **********************************************************************/
         preparedStatementForUpdate = vTradeTabTarget.getUpdateByPkPreparedStatement();
         ...
         while (iterator.hasNext()) {
            ...
            vTradeTabTarget.updateByToAddToBach(preparedStatementForUpdate, vTradeTo);
            ...
            if (executedUpdateStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Updated " + executedUpdateStatement + " records in VIEW \"V_TRADE\".");
               } else {
                  /**********************************************************************
                   *
                   * Results from JDBC are unreliable so we only know that statements are
         ...
         log.info("Number of records after Batch Update: " + vTradeTabTarget.getRowCount());
...
/*************************************************************************
     ...
     //vTradeTabSource.setDbEntityName("GDAODEMO.V_TRADE");
