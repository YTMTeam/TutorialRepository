 ...
 *  <pre>
 *
 *  Generated Class: VExcelMonitoredAccountsSample.java
 * 
 ...
 *
 *  Sample GDAO code for VIEW "V_EXCEL_MONITORED_ACCOUNTS"
 *
...
public class VExcelMonitoredAccountsSample {

   final static Logger log = Logger.getLogger(VExcelMonitoredAccountsSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VExcelMonitoredAccountsSample vExcelMonitoredAccountsSample = new VExcelMonitoredAccountsSample();
         ...
         *
         **********************************************************************/
         //vExcelMonitoredAccountsSample.select(connection);
         //vExcelMonitoredAccountsSample.insert(connection);
         //vExcelMonitoredAccountsSample.update(connection);

         //vExcelMonitoredAccountsSample.dataProvider1(connection);
         //vExcelMonitoredAccountsSample.dataProvider2(connection);

         //vExcelMonitoredAccountsSample.deleteViaResultSet(connection);
         //vExcelMonitoredAccountsSample.deleteViaSQL(connection);
         
         //vExcelMonitoredAccountsSample.batchInsert(connection);
         
         //vExcelMonitoredAccountsSample.selectIntoTransferObject(connection);
         
         //vExcelMonitoredAccountsSample.copyDataBetweenDatabases(connection_source, connection_target);
         //vExcelMonitoredAccountsSample.updateByToArray(connection_source, connection_target);
         
         //vExcelMonitoredAccountsSample.deleteByToArrayBatch(connection_source, connection_target);
         //vExcelMonitoredAccountsSample.deleteByToArray(connection_source, connection_target);
         
         //vExcelMonitoredAccountsSample.updateByTo(connection);
         //vExcelMonitoredAccountsSample.deleteByTo(connection);
   ...
   public void select(Connection connection) throws GDAOException {
      ...
      VExcelMonitoredAccountsTab vExcelMonitoredAccountsTab = new VExcelMonitoredAccountsTab(connection);
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTab.getResultSet("WHERE UPPER(ACCOUNT_ID) LIKE ? AND ROWNUM < ?", "%R%", 100);
          ...
          *
          **********************************************************************/
         //vExcelMonitoredAccountsTab.getResultSet(null, (Object[])null);
         //vExcelMonitoredAccountsTab.getAllRecordsRs();
          ...
          *
          **********************************************************************/
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            *
            **********************************************************************/
            vExcelMonitoredAccountsTab.print("; ");
            ...
            *
            **********************************************************************/
                  accountId = vExcelMonitoredAccountsTab.getACCOUNT_ID();
      monitorBankId = vExcelMonitoredAccountsTab.getMONITOR_BANK_ID();
      accountNumber = vExcelMonitoredAccountsTab.getACCOUNT_NUMBER();
      firstName = vExcelMonitoredAccountsTab.getFIRST_NAME();
      lastName = vExcelMonitoredAccountsTab.getLAST_NAME();
      bankName = vExcelMonitoredAccountsTab.getBANK_NAME();
      ...
      log.debug(String.format("%-30s [%s]", "bankName", bankName));
         ...
         e.printStackTrace();
         log.error("Cannot select from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } finally {
         vExcelMonitoredAccountsTab.releaseStatement();
      }

      log.debug("Finished select from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
   }
   ...
   **********************************************************************/
   public void selectIntoTransferObject(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"selectIntoTransferObject()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
       ...
       *
       **********************************************************************/
      VExcelMonitoredAccountsTab vExcelMonitoredAccountsTabForSelect = new VExcelMonitoredAccountsTab(connection);
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTabForSelect.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelMonitoredAccountsTabForSelect.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTabForSelect.getResultSet("WHERE UPPER(CREDIT_DEBIT_CODE) LIKE ? AND ROWNUM < ?", "%C%", 100);
          ...
          *
          **********************************************************************/
         while (vExcelMonitoredAccountsTabForSelect.next()) {
            ...
            *
            **********************************************************************/
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo  = vExcelMonitoredAccountsTabForSelect.getTo();
             ...
             *
             **********************************************************************/
            //vExcelMonitoredAccountsTo.print();
             ...
             **********************************************************************/
             /*
            vExcelMonitoredAccountsTo.setRECURRING_TRANS_HIST_ID(vExcelMonitoredAccountsTabForSelect.getNextval());
            vExcelMonitoredAccountsTo.setCOMMENTS("This is Zoran's test record");
            vExcelMonitoredAccountsTo.setREJECT_REASON(null);
            vExcelMonitoredAccountsTo.setCREATE_DATETIME(TimestampUtility.getCurrentTimestamp());
            */
             ...
             *
             **********************************************************************/
            VExcelMonitoredAccountsTab vExcelMonitoredAccountsTabForInsert = new VExcelMonitoredAccountsTab(connection);

            vExcelMonitoredAccountsTabForInsert.setThisFromTo(vExcelMonitoredAccountsTo);

            vExcelMonitoredAccountsTabForInsert.insertThisRecord();
         ...
         e.printStackTrace();
         log.error("Cannot select into TO's from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } finally {
         vExcelMonitoredAccountsTabForSelect.releaseStatement();
      }
   ...
   public void insert(Connection connection) throws GDAOException {
      ...
      log.debug("Starting insert into VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"...");
      ...
      try {
         ...
         * BigDecimal VExcelMonitoredAccountsTab_id = VExcelMonitoredAccountsTab.getNextval(sequenceName);
         * or if sequence has a standard name like "S_V_EXCEL_MONITORED_ACCOUNTS":
         * BigDecimal VExcelMonitoredAccountsTab_id = VExcelMonitoredAccountsTab.getNextval();
         *
         **********************************************************************/
      ...
      bankName = "new bankName";
               ...
               vExcelMonitoredAccountsTab.setACCOUNT_ID(accountId);  // java.lang.String - Mandatory
      vExcelMonitoredAccountsTab.setMONITOR_BANK_ID(monitorBankId);  // java.math.BigDecimal - Mandatory
      vExcelMonitoredAccountsTab.setACCOUNT_NUMBER(accountNumber);  // java.math.BigDecimal - Mandatory
      vExcelMonitoredAccountsTab.setFIRST_NAME(firstName);  // java.lang.String - Mandatory
      vExcelMonitoredAccountsTab.setLAST_NAME(lastName);  // java.lang.String - Mandatory
      vExcelMonitoredAccountsTab.setBANK_NAME(bankName);  // java.lang.String - Mandatory


         vExcelMonitoredAccountsTab.insertThisRecord();

      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Cannot insert into VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      }
      

      log.debug("Finished insert into VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
   }
   ...
   public void update(Connection connection) throws GDAOException {
      ...
      log.debug("Starting update of VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
      ...
      try {
          ...
          *
          * Note:
          * Use vExcelMonitoredAccountsTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          *
          * OR
          *
          ...
          *
          **************************************************************************/
         //vExcelMonitoredAccountsTab.setResultSetHoldability(ResultSet.HOLD_CURSORS_OVER_COMMIT);
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTab.getResultSetForUpdate("WHERE ACCOUNT_ID LIKE ?", "%R%");
          ...
          *
          **********************************************************************/
         //vExcelMonitoredAccountsTab.getResultSetForUpdate(null, (Object[])null);
          ...
          *
          **********************************************************************/
         log.info("ResultSet Row Count (number of records to be affected) = " + vExcelMonitoredAccountsTab.getResultSetRowCount());
      ...
      vExcelMonitoredAccountsTab.setBANK_NAME(bankName);  // java.lang.String - Mandatory
           ...
           *
           ***********************************************************************/
            vExcelMonitoredAccountsTab.updateThisRecordInResultSet();
         ...
         e.printStackTrace();
         log.error("Cannot update VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");

         try {
            connection.rollback();  // rollback all updates
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for updating records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            e1.printStackTrace();
      ...
      log.debug("Finished update of VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
   }
   ...
   public void deleteViaSQL(Connection connection) throws GDAOException {
      ...
      log.debug("Starting delete of VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
      ...
      try {
         ...
         recordsDeleted = vExcelMonitoredAccountsTab.deleteRecords(SQL, "%R%");
          ...
          *
          **********************************************************************/
         log.info(recordsDeleted + " records are deleted from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"");
         ...
         e.printStackTrace();
         log.error("Cannot delete  records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");

         try {
            connection.rollback();  // rollback all deletes
         } catch (SQLException e1) {
            log.error("Cannot rollback transaction for deleting records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            e1.printStackTrace();
            throw new GDAOException(e1);
         }
         throw new GDAOException(e);
      ...
      log.debug("Finished delete of VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
   }
   ...
   **********************************************************************/
   public void updateByTo(Connection connection) throws GDAOException {
      ...
      log.debug("Starting UPDATE by TO of VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
      ...
      try {
         ...
         *
         **********************************************************************/
         //vExcelMonitoredAccountsTab.getResultSet("WHERE UPPER(USERNAME) LIKE ? ", "%Z%");
         //vExcelMonitoredAccountsTab.getResultSet(null, (Object[])null);
         //vExcelMonitoredAccountsTab.getAllRecordsRs();
         ...
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            *
            **********************************************************************/
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = vExcelMonitoredAccountsTab.getTo();
            ...
            *
            **********************************************************************/
            //vExcelMonitoredAccountsTo.setCITY("Belgrado"); 
            
            int recordsAffected = vExcelMonitoredAccountsTab.updateRecordUsingTo(vExcelMonitoredAccountsTo);
            ...
            **********************************************************************/
            ...
            //Alternative method:
            //recordsDeleted = vExcelMonitoredAccountsTab.updateRecordsUsingPKs(SQL, vExcelMonitoredAccountsTo.getV_EXCEL_MONITORED_ACCOUNTS_ID());
         ...
         e.printStackTrace();
         log.error("Cannot update records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
   ...
   **********************************************************************/
         ...
         **********************************************************************/
         ...
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            **********************************************************************/
            ...
            int recordsAffected = vExcelMonitoredAccountsTab.deleteRecordUsingTo(vExcelMonitoredAccountsTo);
         
            log.info("Deleted " + recordsAffected + " record with PK values: "  );

            //Alternative method:
            //recordsDeleted = vExcelMonitoredAccountsTab.deleteRecordsUsingPKs(SQL, vExcelMonitoredAccountsTo.getV_EXCEL_MONITORED_ACCOUNTS_ID());
   ...
   public void deleteViaSQLS(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaSQLS()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         while (recordsDeleted !=0) {
            recordsDeleted = vExcelMonitoredAccountsTab.deleteRecords(SQL, "%R%", deleteThisManyRecords);
   ...
   public void deleteViaResultSet(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteViaResultSet()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTab.getResultSet("WHERE ACCOUNT_ID LIKE ?", "%R%");
         ...
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            vExcelMonitoredAccountsTab.deleteThisRecordFromResultSet();
            recordsProcessed++;
   ...
   **********************************************************************/
   public void batchInsert(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"batchInsert()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";

      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      int[] insertCounts = null;
      PreparedStatement ps = null;
      VExcelMonitoredAccountsTab vExcelMonitoredAccountsTab = null;
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER TABLE V_EXCEL_MONITORED_ACCOUNTS DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE TABLE V_EXCEL_MONITORED_ACCOUNTS";
         oracleSystemTab.runSQL(SQL);

         log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" is truncated.");

         vExcelMonitoredAccountsTab = new VExcelMonitoredAccountsTab(connection);
         ...
         * V_EXCEL_MONITORED_ACCOUNTS_BKP 
         * This will affect only selects from this DAO object.
         *
         **********************************************************************/
         vExcelMonitoredAccountsTab.setDbEntityName("V_EXCEL_MONITORED_ACCOUNTS_BKP");
         vExcelMonitoredAccountsTab.getAllRecordsRs();

         vExcelMonitoredAccountsTab.setDbEntityName("V_EXCEL_MONITORED_ACCOUNTS");
         ps = vExcelMonitoredAccountsTab.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vExcelMonitoredAccountsTab.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_EXCEL_MONITORED_ACCOUNTS_BKP
             * using DAO object "vExcelMonitoredAccountsTo"
             *
             **********************************************************************/
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = vExcelMonitoredAccountsTab.getTo();
            vExcelMonitoredAccountsTab.addInsertBatch(ps, vExcelMonitoredAccountsTo);
            ...
            if (recordsInserted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Inserted and committed " + recordsInserted + " records into VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            }
         }
         ...
         e.printStackTrace();
         log.error("Cannot perform DDL/DML on VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } catch (SQLException e) {
         e.printStackTrace();
         throw new GDAOException(e);
   ...
   **********************************************************************/
   public void batchDelete(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"batchDelete()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         //log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" indexes are dropped.");
         ...
         **********************************************************************/
         ...
         vExcelMonitoredAccountsTab.setDbEntityName("V_EXCEL_MONITORED_ACCOUNTS");
         ps = vExcelMonitoredAccountsTab.getDeleteByPkPreparedStatement();
         ...
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            if (recordsDeleted % TRANSACTION_TRESHOLD == 0) {
               ...
               connection.commit();
               log.info("Deleted and committed " + recordsDeleted + " records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            }
         }
   ...
   **********************************************************************/
   public void dataProvider1(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider1()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         vExcelMonitoredAccountsTab.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelMonitoredAccountsTab.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         //vExcelMonitoredAccountsTab.getResultSet("WHERE UPPER(ACCOUNT_ID) LIKE ?", "%R%");
         ...
         **********************************************************************/
         while (vExcelMonitoredAccountsTab.next()) {
            ...
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = vExcelMonitoredAccountsTab.getTo();
             ...
             /**********************************************************************
             *
             * Now use "vExcelMonitoredAccountsTo" object.
            ...
            VExcelMonitoredAccountsTab.print(vExcelMonitoredAccountsTo, "; ");
            ...
            * Change some values:
            * For example:
            * vExcelMonitoredAccountsTo.setSOME_VALUE(123);
            * vExcelMonitoredAccountsTo.setSOME_OTHER_VALUE("Some name");
            * etc...
            *
            **********************************************************************/
            ...
            /**********************************************************************
            *
            * Update row in VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" with values from this
            * Transfer Object vExcelMonitoredAccountsTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            * vExcelMonitoredAccountsTo will be used to find
            * record to be updated. Generally those values should not be changed.
            *
            **********************************************************************/
            //vExcelMonitoredAccountsTab.update(vExcelMonitoredAccountsTo);

            /**********************************************************************
            *
            * Insert row in VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" using values set in
            * this Transfer Object vExcelMonitoredAccountsTo.
            *
            * NOTE:
            * Remember that values for Primary Key have to be unique.
            * Transfer Object vExcelMonitoredAccountsTo could be also
            * created from scratch (not retrieved from the database).
            *
            **********************************************************************/
            //vExcelMonitoredAccountsTab.insert(vExcelMonitoredAccountsTo);

            /**********************************************************************
            *
            * Delete row in VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" with values from this
            * Transfer Object vExcelMonitoredAccountsTo.
            *
            * NOTE:
            * Variables that keep values of the Primary Key in Transfer Object
            ...
            *
            **********************************************************************/
            //vExcelMonitoredAccountsTab.delete(vExcelMonitoredAccountsTo);
         }
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Cannot fetch data from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } finally {
         vExcelMonitoredAccountsTab.releaseStatement();
      }
   ...
   **********************************************************************/
   public void dataProvider2(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"dataProvider2()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
          ...
          * array "vExcelMonitoredAccountsToArray".
          * If there is less than "sampleTransferObjectArraySize"  rows returned
          * then all available data will be stored into array
          * "vExcelMonitoredAccountsToArray".
          *
          * Alternatively you can use parameter "BaseOracleDbEntityClass.FETCH_ALL"
          * to fetch all records returned by result set.
          *
          **********************************************************************/
         //ArrayList<VExcelMonitoredAccountsTo> vExcelMonitoredAccountsToArray = vExcelMonitoredAccountsTab.getToArray(sampleTransferObjectArraySize);
         ArrayList<VExcelMonitoredAccountsTo> vExcelMonitoredAccountsToArray = vExcelMonitoredAccountsTab.getToArray(BaseOracleDbEntityClass.FETCH_ALL);

         Iterator<VExcelMonitoredAccountsTo> iterator = vExcelMonitoredAccountsToArray.iterator();
         while (iterator.hasNext()) {
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = iterator.next();
   ...
   **********************************************************************/
   public void copyDataBetweenDatabases(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"copyDataBetweenDatabases()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      VExcelMonitoredAccountsTab vExcelMonitoredAccountsTabSource = null;
      VExcelMonitoredAccountsTab vExcelMonitoredAccountsTabTarget = null;
      ...
      try {
         ...
         *
         **********************************************************************/
         //SQL = "ALTER VIEW V_EXCEL_MONITORED_ACCOUNTS DISABLE CONSTRAINT ....";
         //oracleSystemTab.runSQL(SQL);

         //SQL = "DROP INDEX ...";
         //oracleSystemTab.runSQL(SQL);

         SQL = "TRUNCATE VIEW V_EXCEL_MONITORED_ACCOUNTS";
         oracleSystemTabTarget.runSQL(SQL);

         log.info("Target VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" is truncated.");

         vExcelMonitoredAccountsTabSource = new VExcelMonitoredAccountsTab(sourceConnection);
         vExcelMonitoredAccountsTabTarget = new VExcelMonitoredAccountsTab(targetConnection);
         ...
         *
         **********************************************************************/
         vExcelMonitoredAccountsTabSource.setResultSetConcurrency(ResultSet.CONCUR_READ_ONLY);
         vExcelMonitoredAccountsTabSource.setResultSetType(ResultSet.TYPE_FORWARD_ONLY);
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTabTarget.setResultSetConcurrency(ResultSet.CONCUR_UPDATABLE);
         vExcelMonitoredAccountsTabTarget.setResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE);
          ...
          *
          **********************************************************************/
         vExcelMonitoredAccountsTabSource.getAllRecordsRs();
          ...
          *
          **********************************************************************/
         preparedStatement = vExcelMonitoredAccountsTabTarget.getInsertPreparedStatement();

         long recordsInserted = 0;
         while (vExcelMonitoredAccountsTabSource.next()) {
            /**********************************************************************
             *
             * Retrieve values from table V_EXCEL_MONITORED_ACCOUNTS
             * using DAO object "vExcelMonitoredAccountsTabSource"
             *
             ...
             *
             **********************************************************************/
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = vExcelMonitoredAccountsTabSource.getTo();

            vExcelMonitoredAccountsTabTarget.addInsertBatch(preparedStatement, vExcelMonitoredAccountsTo);
         ...
         try {
            vExcelMonitoredAccountsTabSource.releaseStatement();
   ...
   **********************************************************************/
   public void deleteByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArrayBatch()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Delete: " + vExcelMonitoredAccountsTabTarget.getRowCount());
          ...
          **********************************************************************/
         vExcelMonitoredAccountsTabSource.getAllRecordsRs();
         ArrayList<VExcelMonitoredAccountsTo> vExcelMonitoredAccountsToArrayList = vExcelMonitoredAccountsTabSource.getToArrayEntireResultSet();
          ...
          *
          **********************************************************************/
         preparedStatement = vExcelMonitoredAccountsTabTarget.getDeleteByPkPreparedStatement();

         Iterator<VExcelMonitoredAccountsTo> iterator = vExcelMonitoredAccountsToArrayList.iterator();
         ...
         while (iterator.hasNext()) {
            ...
            VExcelMonitoredAccountsTo vExcelMonitoredAccountsTo = iterator.next();
            vExcelMonitoredAccountsTabTarget.deleteByToAddToBach(preparedStatement, vExcelMonitoredAccountsTo);
            ...
            if (executedDeleteStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Deleted " + executedDeleteStatement + " records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
               } else {
                  /**********************************************************************
                   *
                   ...
                   *
                   **********************************************************************/
                  log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
               }
            }
         }
         ...
         log.info("Number of records after Batch Delete: " + vExcelMonitoredAccountsTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long deleteByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"deleteByToArray()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Delete: " + vExcelMonitoredAccountsTabTarget.getRowCount());
          ...
          **********************************************************************/
         vExcelMonitoredAccountsTabSource.getAllRecordsRs();
         //vExcelMonitoredAccountsTabSource.getResultSet("WHERE OPERATION_TYPE = ?", "M");
          ...
          * using DAO Object "vExcelMonitoredAccountsTabTarget"
          *
          **********************************************************************/
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            int recordsDeleted = vExcelMonitoredAccountsTabTarget.deleteRecordUsingTo(vExcelMonitoredAccountsTo);
            
            //alternative method - to be tested:
            //vExcelMonitoredAccountsTabTarget.delete(vExcelMonitoredAccountsTo);
            ...
            if (totalRecordsDeleted % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Deleted " + totalRecordsDeleted + " records from VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
               log.info("Executed " + executedDeleteStatement + " delete statements for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            }
         }
         ...
         log.info("Number of records after Delete: " + vExcelMonitoredAccountsTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArray(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArray()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Update: " + vExcelMonitoredAccountsTabTarget.getRowCount());
         ...
         while (iterator.hasNext()) {
             ...
             *
             **********************************************************************/
            //vExcelMonitoredAccountsTo.setOPERATION_TYPE("Z");
             ...
             *
             **********************************************************************/
            int recordsUpdated = vExcelMonitoredAccountsTabTarget.updateRecordUsingTo(vExcelMonitoredAccountsTo);
            ...
            if (totalRecordsUpdated % TRANSACTION_TRESHOLD == 0) {
               targetConnection.commit();
               log.info("Updated " + totalRecordsUpdated + " records in VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
               log.info("Executed " + executedUpdateStatement + " UPDATE statements for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
            }
         }
         ...
         log.info("Number of records after Update: " + vExcelMonitoredAccountsTabTarget.getRowCount());
   ...
   **********************************************************************/
   public long updateByToArrayBatch(Connection sourceConnection, Connection targetConnection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"updateByToArrayBatch()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
         ...
         log.info("Number of records before Batch Update: " + vExcelMonitoredAccountsTabTarget.getRowCount());
          ...
          *
          **********************************************************************/
         preparedStatementForUpdate = vExcelMonitoredAccountsTabTarget.getUpdateByPkPreparedStatement();
         ...
         while (iterator.hasNext()) {
            ...
            vExcelMonitoredAccountsTabTarget.updateByToAddToBach(preparedStatementForUpdate, vExcelMonitoredAccountsTo);
            ...
            if (executedUpdateStatement % TRANSACTION_TRESHOLD == 0) {
               ...
               if (rowsAffected >= 0) {
                  log.info("Updated " + executedUpdateStatement + " records in VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
               } else {
                  /**********************************************************************
                   *
                   * Results from JDBC are unreliable so we only know that statements are
         ...
         log.info("Number of records after Batch Update: " + vExcelMonitoredAccountsTabTarget.getRowCount());
...
/*************************************************************************
     ...
     //vExcelMonitoredAccountsTabSource.setDbEntityName("GDAODEMO.V_EXCEL_MONITORED_ACCOUNTS");
