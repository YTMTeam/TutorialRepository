 ...
 *  <pre>
 *
 *  Generated Class: VExcelMonitoredAccountsDBAdminSample.java
 * 
...
public class VExcelMonitoredAccountsDBAdminSample {

   final static Logger log = Logger.getLogger(VExcelMonitoredAccountsDBAdminSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VExcelMonitoredAccountsDBAdminSample vExcelMonitoredAccountsDBAdminSample = new VExcelMonitoredAccountsDBAdminSample();
         ...
         *
         **********************************************************************/
         //vExcelMonitoredAccountsDBAdminSample.backupTable(connection);
         //vExcelMonitoredAccountsDBAdminSample.restoreTable(connection);
         //vExcelMonitoredAccountsDBAdminSample.restoreTableInOneStatement(connection);
         
         //vExcelMonitoredAccountsDBAdminSample.showVolumesInformation(connection);
         //vExcelMonitoredAccountsDBAdminSample.showMetaDataInformation(connection);
   ...
   * of the VIEW "V_EXCEL_MONITORED_ACCOUNTS"
   *
   ...
   **********************************************************************/
   public void backupTable(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"backupTable()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      log.debug("Backing up VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"...");
      try {
         /**********************************************************************
         *
         ...
         *
         **********************************************************************/
         SQL = "DROP TABLE V_EXCEL_MONITORED_ACCOUNTS_BKP";
         ...
         *
         **********************************************************************/
         SQL = "CREATE TABLE V_EXCEL_MONITORED_ACCOUNTS_BKP AS SELECT * FROM V_EXCEL_MONITORED_ACCOUNTS";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
         log.error("Cannot perform DDL on VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      }

      log.debug("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" is backed up.");
   }

   /**********************************************************************
   *
   * This method demonstrates usage of plain SQL by restoring
   * VIEW "V_EXCEL_MONITORED_ACCOUNTS" from the backup
   *
   * @throws GDAOException
   *
   **********************************************************************/
   public void restoreTableInOneStatement(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"restoreTable()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      
      log.debug("Restoring VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"...");
      ...
      try {
         ...
         **********************************************************************/
         ...
         SQL = "INSERT INTO V_EXCEL_MONITORED_ACCOUNTS (SELECT * FROM V_EXCEL_MONITORED_ACCOUNTS_BKP)";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
      ...
      log.debug("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" is restored from the backup.");
   }
   ...
   *     VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" from the backup table 
   *     V_EXCEL_MONITORED_ACCOUNTS_BKP (see description below).
   ...
   **********************************************************************/
   public void restoreTable(Connection connection) throws GDAOException {
      ...
      log.info("Restoring VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"...");
      try {
         ...
         **********************************************************************/
         ...
         long rowCount = vExcelMonitoredAccountsTab.getRowCount();
         ...
         if (rowCount > TRANSACTION_STRATEGY_TRESHOLD ) {
            ...
            while (vExcelMonitoredAccountsTab.next()) {
                ...
                * using DAO object "vExcelMonitoredAccountsTab"
                *
                **********************************************************************/
               ...
               /**********************************************************************
                *
                * Insert record in table V_EXCEL_MONITORED_ACCOUNTS
                * using the same DAO object "vExcelMonitoredAccountsTab"
                *
                **********************************************************************/
            ...
            log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" has only "
                     + rowCount
      ...
      log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" is restored from the backup TABLE V_EXCEL_MONITORED_ACCOUNTS_BKP.");
   }
   ...
   public void showVolumesInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showVolumesInformation()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
          ...
          if (vExcelMonitoredAccountsTab.exists()) {
             log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" exists in the database.");
          } else {
             log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" does not exist in the database.");
             return;
          }
          ...
          *
          **********************************************************************/
         log.info("VIEW \"V_EXCEL_MONITORED_ACCOUNTS\" row count=" + vExcelMonitoredAccountsTab.getRowCount());
         ...
         *
         **********************************************************************/
         log.info("ResultSet Row Count=" + vExcelMonitoredAccountsTab.getResultSetRowCount());
   ...
   **********************************************************************/
   public void showMetaDataInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showMetaDataInformation()\" for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
          ...
          *
          **********************************************************************/
         tablesResultSet = databaseMetaData.getTables(null, null, "V_EXCEL_MONITORED_ACCOUNTS", null);
          ...
          *
          **********************************************************************/
         columnsResultSet = databaseMetaData.getColumns(null, null, "V_EXCEL_MONITORED_ACCOUNTS", null);
         ...
         **********************************************************************/
         ...
         e.printStackTrace();
         log.error("Cannot get meta data for VIEW \"V_EXCEL_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } finally {
