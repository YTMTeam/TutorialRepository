 ...
 *  <pre>
 *
 *  Generated Class: VExcelAccountDBAdminSample.java
 * 
...
public class VExcelAccountDBAdminSample {

   final static Logger log = Logger.getLogger(VExcelAccountDBAdminSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VExcelAccountDBAdminSample vExcelAccountDBAdminSample = new VExcelAccountDBAdminSample();
         ...
         *
         **********************************************************************/
         //vExcelAccountDBAdminSample.backupTable(connection);
         //vExcelAccountDBAdminSample.restoreTable(connection);
         //vExcelAccountDBAdminSample.restoreTableInOneStatement(connection);
         
         //vExcelAccountDBAdminSample.showVolumesInformation(connection);
         //vExcelAccountDBAdminSample.showMetaDataInformation(connection);
   ...
   **********************************************************************/
   public void backupTable(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"backupTable()\" for VIEW \"V_EXCEL_ACCOUNT\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      log.debug("Backing up VIEW \"V_EXCEL_ACCOUNT\"...");
      try {
         /**********************************************************************
         *
         ...
         *
         **********************************************************************/
         SQL = "DROP TABLE V_EXCEL_ACCOUNT_BKP";
         ...
         *
         **********************************************************************/
         SQL = "CREATE TABLE V_EXCEL_ACCOUNT_BKP AS SELECT * FROM V_EXCEL_ACCOUNT";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
         log.error("Cannot perform DDL on VIEW \"V_EXCEL_ACCOUNT\".");
         throw new GDAOException(e);
      }

      log.debug("VIEW \"V_EXCEL_ACCOUNT\" is backed up.");
   }

   /**********************************************************************
   *
   * This method demonstrates usage of plain SQL by restoring
   * VIEW "V_EXCEL_ACCOUNT" from the backup
   *
   * @throws GDAOException
   *
   **********************************************************************/
   public void restoreTableInOneStatement(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"restoreTable()\" for VIEW \"V_EXCEL_ACCOUNT\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      
      log.debug("Restoring VIEW \"V_EXCEL_ACCOUNT\"...");
      ...
      try {
         ...
         **********************************************************************/
         ...
         SQL = "INSERT INTO V_EXCEL_ACCOUNT (SELECT * FROM V_EXCEL_ACCOUNT_BKP)";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
      ...
      log.debug("VIEW \"V_EXCEL_ACCOUNT\" is restored from the backup.");
   }
   ...
   *     VIEW \"V_EXCEL_ACCOUNT\" from the backup table 
   *     V_EXCEL_ACCOUNT_BKP (see description below).
   ...
   **********************************************************************/
   public void restoreTable(Connection connection) throws GDAOException {
      ...
      log.info("Restoring VIEW \"V_EXCEL_ACCOUNT\"...");
      try {
         ...
         **********************************************************************/
         ...
         if (rowCount > TRANSACTION_STRATEGY_TRESHOLD ) {
            ...
            while (vExcelAccountTab.next()) {
                ...
                * using DAO object "vExcelAccountTab"
                *
                **********************************************************************/
               ...
               /**********************************************************************
                *
                * Insert record in table V_EXCEL_ACCOUNT
                * using the same DAO object "vExcelAccountTab"
                *
                **********************************************************************/
            ...
            log.info("VIEW \"V_EXCEL_ACCOUNT\" has only "
                     + rowCount
      ...
      log.info("VIEW \"V_EXCEL_ACCOUNT\" is restored from the backup TABLE V_EXCEL_ACCOUNT_BKP.");
   }
   ...
   public void showVolumesInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showVolumesInformation()\" for VIEW \"V_EXCEL_ACCOUNT\"";
      ...
      try {
          ...
          if (vExcelAccountTab.exists()) {
             log.info("VIEW \"V_EXCEL_ACCOUNT\" exists in the database.");
          } else {
             log.info("VIEW \"V_EXCEL_ACCOUNT\" does not exist in the database.");
             return;
          }
          ...
          *
          **********************************************************************/
         log.info("VIEW \"V_EXCEL_ACCOUNT\" row count=" + vExcelAccountTab.getRowCount());
         ...
         *
         **********************************************************************/
         log.info("ResultSet Row Count=" + vExcelAccountTab.getResultSetRowCount());
   ...
   **********************************************************************/
   public void showMetaDataInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showMetaDataInformation()\" for VIEW \"V_EXCEL_ACCOUNT\"";
      ...
      try {
         ...
         **********************************************************************/
          ...
          *
          **********************************************************************/
         tablesResultSet = databaseMetaData.getTables(null, null, "V_EXCEL_ACCOUNT", null);
          ...
          *
          **********************************************************************/
         columnsResultSet = databaseMetaData.getColumns(null, null, "V_EXCEL_ACCOUNT", null);
         ...
         **********************************************************************/
         ...
         e.printStackTrace();
         log.error("Cannot get meta data for VIEW \"V_EXCEL_ACCOUNT\".");
         throw new GDAOException(e);
      } finally {
