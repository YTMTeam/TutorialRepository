 ...
 *  <pre>
 *
 *  Generated Class: VMonitoredAccountsDBAdminSample.java
 * 
...
public class VMonitoredAccountsDBAdminSample {

   final static Logger log = Logger.getLogger(VMonitoredAccountsDBAdminSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VMonitoredAccountsDBAdminSample vMonitoredAccountsDBAdminSample = new VMonitoredAccountsDBAdminSample();
         ...
         *
         **********************************************************************/
         //vMonitoredAccountsDBAdminSample.backupTable(connection);
         //vMonitoredAccountsDBAdminSample.restoreTable(connection);
         //vMonitoredAccountsDBAdminSample.restoreTableInOneStatement(connection);
         
         //vMonitoredAccountsDBAdminSample.showVolumesInformation(connection);
         //vMonitoredAccountsDBAdminSample.showMetaDataInformation(connection);
   ...
   * of the VIEW "V_MONITORED_ACCOUNTS"
   *
   ...
   **********************************************************************/
   public void backupTable(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"backupTable()\" for VIEW \"V_MONITORED_ACCOUNTS\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      log.debug("Backing up VIEW \"V_MONITORED_ACCOUNTS\"...");
      try {
         /**********************************************************************
         *
         ...
         *
         **********************************************************************/
         SQL = "DROP TABLE V_MONITORED_ACCOUNTS_BKP";
         ...
         *
         **********************************************************************/
         SQL = "CREATE TABLE V_MONITORED_ACCOUNTS_BKP AS SELECT * FROM V_MONITORED_ACCOUNTS";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
         log.error("Cannot perform DDL on VIEW \"V_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      }

      log.debug("VIEW \"V_MONITORED_ACCOUNTS\" is backed up.");
   }

   /**********************************************************************
   *
   * This method demonstrates usage of plain SQL by restoring
   * VIEW "V_MONITORED_ACCOUNTS" from the backup
   *
   * @throws GDAOException
   *
   **********************************************************************/
   public void restoreTableInOneStatement(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"restoreTable()\" for VIEW \"V_MONITORED_ACCOUNTS\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      
      log.debug("Restoring VIEW \"V_MONITORED_ACCOUNTS\"...");
      ...
      try {
         ...
         **********************************************************************/
         ...
         SQL = "INSERT INTO V_MONITORED_ACCOUNTS (SELECT * FROM V_MONITORED_ACCOUNTS_BKP)";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
      ...
      log.debug("VIEW \"V_MONITORED_ACCOUNTS\" is restored from the backup.");
   }
   ...
   *     VIEW \"V_MONITORED_ACCOUNTS\" from the backup table 
   *     V_MONITORED_ACCOUNTS_BKP (see description below).
   ...
   **********************************************************************/
   public void restoreTable(Connection connection) throws GDAOException {
      ...
      log.info("Restoring VIEW \"V_MONITORED_ACCOUNTS\"...");
      try {
         ...
         **********************************************************************/
         ...
         if (rowCount > TRANSACTION_STRATEGY_TRESHOLD ) {
            ...
            while (vMonitoredAccountsTab.next()) {
                ...
                * using DAO object "vMonitoredAccountsTab"
                *
                **********************************************************************/
               ...
               /**********************************************************************
                *
                * Insert record in table V_MONITORED_ACCOUNTS
                * using the same DAO object "vMonitoredAccountsTab"
                *
                **********************************************************************/
            ...
            log.info("VIEW \"V_MONITORED_ACCOUNTS\" has only "
                     + rowCount
      ...
      log.info("VIEW \"V_MONITORED_ACCOUNTS\" is restored from the backup TABLE V_MONITORED_ACCOUNTS_BKP.");
   }
   ...
   public void showVolumesInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showVolumesInformation()\" for VIEW \"V_MONITORED_ACCOUNTS\"";
      ...
      try {
          ...
          if (vMonitoredAccountsTab.exists()) {
             log.info("VIEW \"V_MONITORED_ACCOUNTS\" exists in the database.");
          } else {
             log.info("VIEW \"V_MONITORED_ACCOUNTS\" does not exist in the database.");
             return;
          }
          ...
          *
          **********************************************************************/
         log.info("VIEW \"V_MONITORED_ACCOUNTS\" row count=" + vMonitoredAccountsTab.getRowCount());
         ...
         *
         **********************************************************************/
         log.info("ResultSet Row Count=" + vMonitoredAccountsTab.getResultSetRowCount());
   ...
   **********************************************************************/
   public void showMetaDataInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showMetaDataInformation()\" for VIEW \"V_MONITORED_ACCOUNTS\"";
      ...
      try {
         ...
         **********************************************************************/
          ...
          *
          **********************************************************************/
         tablesResultSet = databaseMetaData.getTables(null, null, "V_MONITORED_ACCOUNTS", null);
          ...
          *
          **********************************************************************/
         columnsResultSet = databaseMetaData.getColumns(null, null, "V_MONITORED_ACCOUNTS", null);
         ...
         **********************************************************************/
         ...
         e.printStackTrace();
         log.error("Cannot get meta data for VIEW \"V_MONITORED_ACCOUNTS\".");
         throw new GDAOException(e);
      } finally {
