 ...
 *  <pre>
 *
 *  Generated Class: BlockDBAdminSample.java
 * 
...
public class BlockDBAdminSample {

   final static Logger log = Logger.getLogger(BlockDBAdminSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        BlockDBAdminSample blockDBAdminSample = new BlockDBAdminSample();
         ...
         *
         **********************************************************************/
         //blockDBAdminSample.backupTable(connection);
         //blockDBAdminSample.restoreTable(connection);
         //blockDBAdminSample.restoreTableInOneStatement(connection);
         
         //blockDBAdminSample.showVolumesInformation(connection);
         //blockDBAdminSample.showMetaDataInformation(connection);
   ...
   **********************************************************************/
   public void backupTable(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"backupTable()\" for TABLE \"BLOCK\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      log.debug("Backing up TABLE \"BLOCK\"...");
      try {
         /**********************************************************************
         *
         ...
         *
         **********************************************************************/
         SQL = "CREATE TABLE BLOCK_BKP AS SELECT * FROM BLOCK";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
         log.error("Cannot perform DDL on TABLE \"BLOCK\".");
         throw new GDAOException(e);
      }

      log.debug("TABLE \"BLOCK\" is backed up.");
   }

   /**********************************************************************
   *
   * This method demonstrates usage of plain SQL by restoring
   * TABLE "BLOCK" from the backup
   *
   * @throws GDAOException
   *
   **********************************************************************/
   public void restoreTableInOneStatement(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"restoreTable()\" for TABLE \"BLOCK\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      
      log.debug("Restoring TABLE \"BLOCK\"...");
      ...
      try {
         ...
         **********************************************************************/
         ...
         SQL = "INSERT INTO BLOCK (SELECT * FROM BLOCK_BKP)";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
      ...
      log.debug("TABLE \"BLOCK\" is restored from the backup.");
   }
   ...
   *     TABLE \"BLOCK\" from the backup table 
   *     BLOCK_BKP (see description below).
   ...
   **********************************************************************/
   public void restoreTable(Connection connection) throws GDAOException {
      ...
      log.info("Restoring TABLE \"BLOCK\"...");
      try {
         ...
         **********************************************************************/
         ...
         if (rowCount > TRANSACTION_STRATEGY_TRESHOLD ) {
            ...
            while (blockTab.next()) {
               ...
               /**********************************************************************
                *
                * Insert record in table BLOCK
                * using the same DAO object "blockTab"
                *
                **********************************************************************/
      ...
      log.info("TABLE \"BLOCK\" is restored from the backup TABLE BLOCK_BKP.");
   }
   ...
   public void showVolumesInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showVolumesInformation()\" for TABLE \"BLOCK\"";
      ...
      try {
          ...
          if (blockTab.exists()) {
             log.info("TABLE \"BLOCK\" exists in the database.");
          } else {
             log.info("TABLE \"BLOCK\" does not exist in the database.");
             return;
          }
          ...
          *
          **********************************************************************/
         log.info("TABLE \"BLOCK\" row count=" + blockTab.getRowCount());
         ...
         *
         **********************************************************************/
         log.info("ResultSet Row Count=" + blockTab.getResultSetRowCount());
   ...
   **********************************************************************/
   public void showMetaDataInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showMetaDataInformation()\" for TABLE \"BLOCK\"";
      ...
      try {
         ...
         **********************************************************************/
          ...
          *
          **********************************************************************/
         tablesResultSet = databaseMetaData.getTables(null, null, "BLOCK", null);
          ...
          *
          **********************************************************************/
         columnsResultSet = databaseMetaData.getColumns(null, null, "BLOCK", null);
         ...
         **********************************************************************/
         ...
         e.printStackTrace();
         log.error("Cannot get meta data for TABLE \"BLOCK\".");
         throw new GDAOException(e);
      } finally {
