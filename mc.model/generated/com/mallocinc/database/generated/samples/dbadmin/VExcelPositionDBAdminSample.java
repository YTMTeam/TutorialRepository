 ...
 *  <pre>
 *
 *  Generated Class: VExcelPositionDBAdminSample.java
 * 
...
public class VExcelPositionDBAdminSample {

   final static Logger log = Logger.getLogger(VExcelPositionDBAdminSample.class.getName());
   ...
   public static void main(String[] args) {
     ...
     try {
        ...
        *
        **********************************************************************/
        VExcelPositionDBAdminSample vExcelPositionDBAdminSample = new VExcelPositionDBAdminSample();
         ...
         *
         **********************************************************************/
         //vExcelPositionDBAdminSample.backupTable(connection);
         //vExcelPositionDBAdminSample.restoreTable(connection);
         //vExcelPositionDBAdminSample.restoreTableInOneStatement(connection);
         
         //vExcelPositionDBAdminSample.showVolumesInformation(connection);
         //vExcelPositionDBAdminSample.showMetaDataInformation(connection);
   ...
   **********************************************************************/
   public void backupTable(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"backupTable()\" for VIEW \"V_EXCEL_POSITION\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      log.debug("Backing up VIEW \"V_EXCEL_POSITION\"...");
      try {
         /**********************************************************************
         *
         ...
         *
         **********************************************************************/
         SQL = "DROP TABLE V_EXCEL_POSITION_BKP";
         ...
         *
         **********************************************************************/
         SQL = "CREATE TABLE V_EXCEL_POSITION_BKP AS SELECT * FROM V_EXCEL_POSITION";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
         log.error("Cannot perform DDL on VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      }

      log.debug("VIEW \"V_EXCEL_POSITION\" is backed up.");
   }

   /**********************************************************************
   *
   * This method demonstrates usage of plain SQL by restoring
   * VIEW "V_EXCEL_POSITION" from the backup
   *
   * @throws GDAOException
   *
   **********************************************************************/
   public void restoreTableInOneStatement(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"restoreTable()\" for VIEW \"V_EXCEL_POSITION\"";
   
      String SQL = null;
      OracleSystemTab oracleSystemTab = new OracleSystemTab(connection);
      
      log.debug("Restoring VIEW \"V_EXCEL_POSITION\"...");
      ...
      try {
         ...
         **********************************************************************/
         ...
         SQL = "INSERT INTO V_EXCEL_POSITION (SELECT * FROM V_EXCEL_POSITION_BKP)";
         oracleSystemTab.runSQL(SQL);
      } catch (GDAOException e) {
         e.printStackTrace();
         log.error("Error occurred while executing SQL statement:" + SQL);
      ...
      log.debug("VIEW \"V_EXCEL_POSITION\" is restored from the backup.");
   }
   ...
   *     VIEW \"V_EXCEL_POSITION\" from the backup table 
   *     V_EXCEL_POSITION_BKP (see description below).
   ...
   **********************************************************************/
   public void restoreTable(Connection connection) throws GDAOException {
      ...
      log.info("Restoring VIEW \"V_EXCEL_POSITION\"...");
      try {
         ...
         **********************************************************************/
         ...
         if (rowCount > TRANSACTION_STRATEGY_TRESHOLD ) {
            ...
            while (vExcelPositionTab.next()) {
                ...
                * using DAO object "vExcelPositionTab"
                *
                **********************************************************************/
               ...
               /**********************************************************************
                *
                * Insert record in table V_EXCEL_POSITION
                * using the same DAO object "vExcelPositionTab"
                *
                **********************************************************************/
            ...
            log.info("VIEW \"V_EXCEL_POSITION\" has only "
                     + rowCount
      ...
      log.info("VIEW \"V_EXCEL_POSITION\" is restored from the backup TABLE V_EXCEL_POSITION_BKP.");
   }
   ...
   public void showVolumesInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showVolumesInformation()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
          ...
          if (vExcelPositionTab.exists()) {
             log.info("VIEW \"V_EXCEL_POSITION\" exists in the database.");
          } else {
             log.info("VIEW \"V_EXCEL_POSITION\" does not exist in the database.");
             return;
          }
          ...
          *
          **********************************************************************/
         log.info("VIEW \"V_EXCEL_POSITION\" row count=" + vExcelPositionTab.getRowCount());
         ...
         *
         **********************************************************************/
         log.info("ResultSet Row Count=" + vExcelPositionTab.getResultSetRowCount());
   ...
   **********************************************************************/
   public void showMetaDataInformation(Connection connection) throws GDAOException {
      ...
      String whatWeAreDoing = "\"showMetaDataInformation()\" for VIEW \"V_EXCEL_POSITION\"";
      ...
      try {
         ...
         **********************************************************************/
          ...
          *
          **********************************************************************/
         tablesResultSet = databaseMetaData.getTables(null, null, "V_EXCEL_POSITION", null);
          ...
          *
          **********************************************************************/
         columnsResultSet = databaseMetaData.getColumns(null, null, "V_EXCEL_POSITION", null);
         ...
         **********************************************************************/
         ...
         e.printStackTrace();
         log.error("Cannot get meta data for VIEW \"V_EXCEL_POSITION\".");
         throw new GDAOException(e);
      } finally {
