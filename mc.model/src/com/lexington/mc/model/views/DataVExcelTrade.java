...
public class DataVExcelTrade {
	final static Logger log = Logger.getLogger(DataVExcelTrade.class.getName());

	public VExcelTradeTab getExcelDataForAccount(Connection conn, String account) throws GDAOException {
		...
		try {
			 ...
			 *
			 **********************************************************************/
			VExcelTradeTab.getResultSet("WHERE ACCOUNT_ID = ?",account);
