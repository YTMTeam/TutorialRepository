...
public class SelectMonitoredAccountsLazy extends LazyDataModel<EntityVMonitoredAccountDeprecated>implements SelectableDataModel<EntityVMonitoredAccountDeprecated>{
	 private static final long  serialVersionUID    = -6018436278490045301L;
	   ...
	   public SelectMonitoredAccountsLazy(BigDecimal bankId) {
		   this.bankId = bankId;
	   }
...
//			  sortField="CREATE_TIMESTAMP";
	      ...
	      try {
	    	  ...
	    	  result = accountProvider.getMonitoredAccountsForPaging(first, pageSize, sortField, dbUtil.translateSortOrder(sortOrder), filters,bankId);
	      ...
	      try {
	         int rowCnt = (int) accountProvider.getMonitoredAccountsFilterCount(filters, bankId);
